...
namespace SignalRAssignment.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(SalesManagementContext context)
        {
            _context = context;
        }
        ...
        {
            var salesManagementContext = _context.OrderDetails.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SalesManagementContext.OrderDetails'  is null.");
            }
            var orderDetail = await _context.OrderDetails.FindAsync(id);
            if (orderDetail != null)
            {
